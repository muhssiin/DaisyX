...
STICKERS = (
    "CAACAgUAAxkBAAJrX2EBiaIe8a_V3Q9Zm9iZ9_ACDO1PAAJzAwACfSYRVM152wQIwiCzIAQ",
    "CAACAgUAAxkBAAJrYmEBiaf0iIAw_D9eN807Hu1pfdO1AAJjBAACIboJVLmXR0z1VM5_IAQ",
    "CAACAgUAAxkBAAJrZWEBjLTasZ-mU1W-agIiGejjtQosAAJfAwACpJMJVHCuTWLLNHHzIAQ",
    "CAACAgUAAxkBAAJrYmEBiaf0iIAw_D9eN807Hu1pfdO1AAJjBAACIboJVLmXR0z1VM5_IAQ",
    "CAACAgUAAxkBAAJrZWEBjLTasZ-mU1W-agIiGejjtQosAAJfAwACpJMJVHCuTWLLNHHzIAQ",
    "CAACAgUAAxkBAAJrYmEBiaf0iIAw_D9eN807Hu1pfdO1AAJjBAACIboJVLmXR0z1VM5_IAQ",
    "CAACAgUAAxkBAAJrZWEBjLTasZ-mU1W-agIiGejjtQosAAJfAwACpJMJVHCuTWLLNHHzIAQ",
...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        ...
        InlineKeyboardButton(
            strings["btn_source"], url="https://t.me/smplmcube/7"
        ),
    )
    buttons.add(
        InlineKeyboardButton(strings["btn_channel"], url="https://t.me/Mcubemediaofficial"),
        InlineKeyboardButton(
            strings["btn_group"], url="https://t.me/joinchat/F_6ts1iYxSE4YzNl"
        ),
    )
    buttons.add(
        InlineKeyboardButton(
            "👸🏼 Add Manager to your group",
            url=f"https://telegram.me/MCubemanagerbot?startgroup=true",
        )
    )
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/MCubeManagerBot?start")
    )
    await message.reply(strings["help_header"], reply_markup=button)
